...
const socialLinks = [
  ...
  {
    name: "LinkedIn",
    url: "https://linkedin.com/in/imdebashishroy",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Twitter",
    url: "https://twitter.com/imdebashishroy",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        >
          <p className="text-gray-500 text-sm">
            © {currentYear} Debashish. All rights reserved.
          </p>
        </motion.div>
      </div>
    </footer>
